...
#main que gestiona los bucles y recive la ubicacion del archivo csv 
def main():
    file=input("Path del archivo .csv: ")
    print(file)
    """
    for k in range(1, 5, 2):
        for d in range(1, 5, 2):
            knn(f,k,d)
            print("Ejecucion de algoritmo knn terminada con k=" + k + " d=" + d)
    """
"""
def knn(f, k, d):
